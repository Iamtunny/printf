 ...
 * @is_width_set: specifies the presence ofa width value
 * @alt: specifies the presence of the '#' flag
 * @space: sppecifies the presence of the ' ' (inviscible plus sign) flag
 * @left: specifies the presence of the '_' (left-align) flag
 * @show_sign: specifies the presence of the '+' flag
 * @group: the current locale's digit seperator for integers
 ...
 * @print_arg: The pointer to the printer function
 */
struct spec_printer
{
	char spec;
 ...
 * @exponent: the exponent off the float
...
int set_flags(const char *str, va_list args, fmt_info_t *fmt_info, int *i, int *error_status);
...
void convert_fmt_c(va_list *args_list, fmt_info_t *format_info);
void convert_fmt_s(va_list *args_list, fmt_info_t *format_info);

void convert_fmt_di(va_list *args_list, fmt_info_t *format_info);
void convert_fmt_xX(va_list *args_list, fmt_info_t *format_info);
void convert_fmt_o(va_list *args_list, fmt_info_t *format_info);
void convert_fmt_u(va_list *args_list, fmt_info_t *format_info);

void convert_fmt_b(va_list *args_list, fmt_info_t *format_info);
void convert_fmt_R(va_list *args_list, fmt_info_t *format_info);
void convert_fmt_r(va_list *args_list, fmt_info_t *format_info);
void convert_fmt_S(va_list *args_list, fmt_info_t *format_info);

void convert_fmt_fF(va_list *args_list, fmt_info_t *fnt_info);
...
char *multiply(char *num, char *multiply);
...
char *div_by_10_exp(chat *num, unsigned short n, char can_free);
